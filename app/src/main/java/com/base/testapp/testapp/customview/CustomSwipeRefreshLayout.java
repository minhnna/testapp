...
public class CustomSwipeRefreshLayout extends ViewGroup {
    ...
    private CustomSwipeRefreshLayoutDirection mDirection;
    ...
    public CustomSwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        CustomSwipeRefreshLayoutDirection direction
                = CustomSwipeRefreshLayoutDirection.getFromInt(a2.getInt(R.styleable.CustomSwipeRefreshLayout_srl_direction, 0));
        if (direction != CustomSwipeRefreshLayoutDirection.BOTH) {
            mDirection = direction;
            mBothDirection = false;
        } else {
            mDirection = CustomSwipeRefreshLayoutDirection.TOP;
            mBothDirection = true;
        }
        a2.recycle();
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mBothDirection) {
                    if (y > mInitialDownY) {
                        setRawDirection(CustomSwipeRefreshLayoutDirection.TOP);
                    } else if (y < mInitialDownY) {
                        setRawDirection(CustomSwipeRefreshLayoutDirection.BOTTOM);
                    }
                    if ((mDirection == CustomSwipeRefreshLayoutDirection.BOTTOM && canChildScrollDown())
                            || (mDirection == CustomSwipeRefreshLayoutDirection.TOP && canChildScrollUp())) {
                        mInitialDownY = y;
                        return false;
                    }
                }
            ...
            switch (action) {
                ...
                case MotionEvent.ACTION_MOVE: {
                    ...
                    if (mIsBeingDragged) {
                        ...
                        int targetY;
                        if (mDirection == CustomSwipeRefreshLayoutDirection.TOP) {
...
//        }
    ...
    public CustomSwipeRefreshLayoutDirection getDirection() {
        return mBothDirection ? CustomSwipeRefreshLayoutDirection.BOTH : mDirection;
    }

    public void setDirection(CustomSwipeRefreshLayoutDirection direction) {
        if (direction == CustomSwipeRefreshLayoutDirection.BOTH) {
            mBothDirection = true;
        } else {
            mBothDirection = false;
    ...
    // only TOP or Bottom
    private void setRawDirection(CustomSwipeRefreshLayoutDirection direction) {
