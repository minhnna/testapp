...
public class MediaManager implements TextureView.SurfaceTextureListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnSeekCompleteListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnVideoSizeChangedListener {
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i1) {
        Log.i(TAG, "onSurfaceTextureAvailable [" + VideoPlayerManager.getCurrentVd().hashCode() + "] ");
    ...
    public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i1) {
        Log.i(TAG, "onSurfaceTextureSizeChanged [" + VideoPlayerManager.getCurrentVd().hashCode() + "] ");
    }
        ...
        mainThreadHandler.post(new Runnable() {
            ...
            public void run() {
                if (VideoPlayerManager.getCurrentVd() != null) {
                    VideoPlayerManager.getCurrentVd().onPrepared();
                }
            }
        });
    }
    ...
    public void onCompletion(MediaPlayer mp) {
        mainThreadHandler.post(new Runnable() {
            ...
            public void run() {
                if (VideoPlayerManager.getCurrentVd() != null) {
                    VideoPlayerManager.getCurrentVd().onAutoCompletion();
                }
            }
        });
    }
    ...
    public void onBufferingUpdate(MediaPlayer mp, final int percent) {
        mainThreadHandler.post(new Runnable() {
            ...
            public void run() {
                if (VideoPlayerManager.getCurrentVd() != null) {
                    VideoPlayerManager.getCurrentVd().setBufferProgress(percent);
                }
            }
        });
    }
    ...
    public void onSeekComplete(MediaPlayer mp) {
        mainThreadHandler.post(new Runnable() {
            ...
            public void run() {
                if (VideoPlayerManager.getCurrentVd() != null) {
                    VideoPlayerManager.getCurrentVd().onSeekComplete();
                }
            }
        });
    }
    ...
    public boolean onError(MediaPlayer mp, final int what, final int extra) {
        mainThreadHandler.post(new Runnable() {
            ...
            public void run() {
                if (VideoPlayerManager.getCurrentVd() != null) {
                    VideoPlayerManager.getCurrentVd().onError(what, extra);
                }
            }
        });
        return true;
    ...
    public boolean onInfo(MediaPlayer mp, final int what, final int extra) {
        mainThreadHandler.post(new Runnable() {
            ...
            public void run() {
                if (VideoPlayerManager.getCurrentVd() != null) {
                    VideoPlayerManager.getCurrentVd().onInfo(what, extra);
                }
            }
        });
        return false;
    ...
    public void onVideoSizeChanged(MediaPlayer mp, int width, int height) {
        ...
        mainThreadHandler.post(new Runnable() {
            ...
            public void run() {
                if (VideoPlayerManager.getCurrentVd() != null) {
                    VideoPlayerManager.getCurrentVd().onVideoSizeChanged();
                }
            }
        });
    }
